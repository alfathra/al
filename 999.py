     ...
     while True:
        ...
        if obj["Config"][urut]["Max Bet"] == "OFF" or obj["Config"][urut]["Max Bet"] == "off" or obj["Config"][urut]["Max Bet"] == "Off":
           ...
           if amount > int(float(obj["Config"][urut]["Max Bet"])*(10 ** 8)):
               amount = payin
        if obj["Config"][urut]["Bet"]["H / L"]["Toggle"] == "On" or obj["Config"][urut]["Bet"]["H / L"]["Toggle"] == "ON" or obj["Config"][urut]["Bet"]["H / L"]["Toggle"] == "on":
            no_rolebet +=1
            if stats_rolebet_win is True:
               if no_rolebet > int(obj["Config"][urut]["Bet"]["H / L"]["If Win"]) - 1:
                  rolebet = " L "
               if no_rolebet > int(obj["Config"][urut]["Bet"]["H / L"]["If Win"]) * 2 - 1:
                  rolebet = " H "
                  no_rolebet = 0
            if stats_rolebet_lose is True:
               if no_rolebet > int(obj["Config"][urut]["Bet"]["H / L"]["If Lose"]) -1 :
                  rolebet = " L "
               if no_rolebet > int(obj["Config"][urut]["Bet"]["H / L"]["If Lose"]) * 2 - 1:
                  rolebet = " H "
                  no_rolebet = 0
        else:
        ...
        if jsn["PayOut"] != 0:
           ...
           if prof > 0:
             print (bgreen+putih2+" "+str(rolebet)+" "+res,hijau+"+"+str(rev(str(amount))+res),putih2+str(rev(str(bal))+res),abu2+"["+res+hijau+"Profit"+res+abu2+"]"+res,hijau+str(rev(str(bal - js[currency]["Balance"]))),abu2+"["+res +kuning+"Total"+abu2+"]"+res, putih2+str(rupiah_format(marketidx * float(int(bal))/(10 ** 8)))+res)
           else:
             print (bgreen+putih2+" "+str(rolebet)+" "+res,hijau+"+"+str(rev(str(amount))+res),putih2+str(rev(str(bal))+res),abu2+" ["+res+red+"Lose"+res+abu2+"]"+res,red+str(rev(str(bal - js[currency]["Balance"]))),abu2+"["+res+kuning+"Total"+abu2+"]"+res, putih2+str(rupiah_format(marketidx * float(int(bal))/(10 ** 8)))+res)
           ...
           bal = int(jsn["StartingBalance"]) + int(jum)
           if prof > 0:
             print (bred+putih2+" "+str(rolebet)+" "+res,red+"-"+str(rev(str(amount))+res),putih2+str(rev(str(bal))),abu2+"["+res+hijau+"Profit"+res+abu2+"]"+res,hijau+str(rev(str(bal - js[currency]["Balance"]))),abu2+"["+res+kuning+"Total"+abu2+"]"+res, putih2+str(rupiah_format(marketidx * float(int(bal))/(10 ** 8)))+res)
           else:
             print (bred+putih2+" "+str(rolebet)+" "+res,red+"-"+str(rev(str(amount))),putih2+str(rev(str(bal))),abu2+" ["+res+red+"Lose"+res+abu2+"]"+res,red+str(rev(str(bal - js[currency]["Balance"]))),abu2+"["+res+kuning+"Total"+res+abu2+"]", putih2+str(rupiah_format(marketidx * float(int(bal))/(10 ** 8)))+res)
